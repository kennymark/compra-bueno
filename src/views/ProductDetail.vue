  ...
  <Layout>
    <div class="row">
      ...
      <div class="col-lg offset-1 mt-5">
        <h3 class="text-capitalize is-size-4">
          {{ product.name }}
        </h3>
        ...
        <p class="text-capitalize">
          Seller: {{ product.prices_merchant || 'not listed' }}
        </p>
        <p class="text-capitalize">
    ...
    <div class="row">
      <div class="col-lg p-5">
        ...
        <p
          ...
          class="mt-4"
        >
          No features provided available
        </p>
      </div>
      <div class="col mt-5">
        <h5 class="is-size-5">
        ...
        >
          {{ product.descriptions[0].value | truncate(descriptionLength) }}
        </p>
        <p
          v-if="!product.descriptions[0]"
          class="mt-4"
